...
class Buyer extends Resource
{
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            Text::make('First Name', 'fname')->sortable()->rules('required'),
            Text::make('Last Name', 'lname')->sortable()->rules('required'),
            Text::make('Street')->rules('required'),
            Text::make('Apartment')->rules('required'),
            Text::make('City')->rules('required'),
            Text::make('State')->rules('required'),
            Number::make('Zip')->rules('required'),
