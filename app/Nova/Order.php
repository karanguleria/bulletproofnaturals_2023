...
class Order extends Resource
{
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            Number::make('billing_discount')->min(0.00)->max(1000000)->step(0.01),
            ...
            //Text::make('exp_year'),
            //Text::make('last4'),
            Number::make('billing_base_total')->min(0.00)->max(1000000)->step(0.01),
            Number::make('billing_subtotal')->min(0.00)->max(1000000)->step(0.01),
            Number::make('billing_tax')->min(0.00)->max(1000000)->step(0.01),
            Number::make('billing_total')->min(0.00)->max(1000000)->step(0.01),
